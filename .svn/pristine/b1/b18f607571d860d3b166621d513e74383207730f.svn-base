...
public enum NativeType {
     ...
     * <tt>BSTR</tt>.
     *
     * <p> Expected Java type: String
     */
    BSTR(1, 4),
    /**
     * <tt>BSTR*</tt>.
     *
     * TODO: support StringBuffer <p> Expected Java type: {@link Holder}<String>
     */
     ...
     *
     * <p> More concretely, it becomes a '\0'-terminated multi-byte string where
     * characters are encoded according to the platform default encoding.
     *
     * <p> For example, on a typical English Windows system this is just an
     * ASCII string (more or less). On a typical Japanese Windows system, this
     * is Shift-JIS.
     */
    CSTR(3, 4),
    /**
     * <tt>INT8</tt> (byte).
     *
     * <p> Expected Java type: byte {@link Number}
     */
    Int8(100, 1), Int8_ByRef(100 | BYREF, 1),
    /**
     * <tt>INT16</tt> (short).
     *
     * <p> Expected Java type: short {@link Number}
     */
    Int16(101, 2), Int16_ByRef(101 | BYREF, 2),
    /**
     * Marshalled as 32-bit integer.
     *
     * <p> Java "int" is 32 bit.
     *
     * <p> Expected Java type: int {@link Number} {@link Enum}
     */
    Int32(102, 4) {
    ...
    /**
     * The native type is 'BOOL' (defined as 'int') where <tt>true</tt> maps to
     * -1 and <tt>false</tt> maps to 0.
     *
     * <p> Expected Java type: boolean {@link Boolean}
     */
    Bool(103, 4),
    /**
     ...
     * <tt>float</tt>.
     *
     * <p> Expected Java type: boolean {@link Number}
     */
    Float(120, 4),
    /**
     * <tt>double</tt>.
     ...
     * <tt>PVOID</tt>.
     *
     * <p> The assumed semantics is that a region of buffer will be passed to
     * the native method.
     *
     * <p> Expected Java type: direct {@link Buffer}s ({@link Buffer}s created
     ...
     * <tt>void**</tt>.
     *
     * <p> The assumed semantics is that you receive a buffer.
     *
     * <p> Expected Java type:
     * {@link Holder}&lt;{@link Buffer}> ({@link Buffer}s created from methods
     * like {@link ByteBuffer#allocateDirect(int)}
     */
     ...
     * <p> Expected Java type: {@link java.util.Date} {@link Calendar}
     */
    Date(400, 8) {
        // the native code will see the raw pointer value as Integer
        @Override
     ...
     * code. <p> This allows {@link NativeType}s to take more Java-friendly
     * argument and convert it to more native code friendly form behind the
     * scene.
     *
    ...
    /**
     * Changes the parameter type before the method call returns. <p> The
     * opposite of {@link #massage(java.lang.Object)}. Only useful for BYREFs.
     *
