...
public abstract class NLink {
     ...
     *
     * @param dllInterface An interface with {@link DllClass} annotation. Must
     * not be null.
     *
     ...
     * Creates a method invocation converter for the given interface.
     *
     * <p> This is the extended version of {@link #create(Class)} that allows a
     * DLL to be specified explicitly.
     *
     * @param dllInterface An interface with {@link DllClass} annotation. Must
     * not be null.
     *
     * @param library The full path of the DLL file to be loaded. Must not be
     * null.
     *
     * @return The created converter. Always non-null.
     */
